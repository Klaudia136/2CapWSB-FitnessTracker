...
class UserController {
    ...
    public User addUser(@RequestBody UserDto userDto) throws InterruptedException {
        try {
            ...
            throw new IllegalArgumentException(" You can't create user " + userDto.email() + " Error: " + e.getMessage());
        }

        // Demonstracja how to use @RequestBody
        System.out.println(" E-mail: " + userDto.email() + " is correct ");
    ...
    public User updateUser(@PathVariable Long userId, @RequestBody UserDto userDto) {
        try {
            ...
            throw new IllegalArgumentException(" You can't update user with ID: " + userId + " Error: " + e.getMessage());
        }
    }
    ...
    public void deleteUser(@PathVariable Long userId) {
        try {
            ...
            throw new IllegalArgumentException("You can't delete user with ID: " + userId + " Error: " + e.getMessage());
        }
    }
}